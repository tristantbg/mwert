module.exports = function(grunt) {
    grunt.initConfig({
        concat: {
            plugins: {
                src: ['site/plugins/oembed/assets/js/oembed.js', 'lib/lazysizes/lazysizes.min.js', 'lib/lazysizes/plugins/optimumx/ls.optimumx.min.js', 'lib/lazysizes/plugins/bgset/ls.bgset.min.js', 'lib/history.js/scripts/bundled/html4+html5/jquery.history.js'],
